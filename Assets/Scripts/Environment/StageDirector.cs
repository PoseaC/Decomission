...
public class StageDirector : MonoBehaviour
{
    ...
    public void ChangeLevel()
    {
        ...
        PlayerMovementManager.instance.playerBody.position = startPositions[activeLevel].position;
        AgentIO.input.TargetPosition = targetPositions[activeLevel].position;
    }
}
